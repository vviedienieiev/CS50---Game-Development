...
function LevelMaker.createMap(level)
    ...
    local highestColor = math.min(1, level % 5 + 3)


    local lockedChance = 0.1
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if math.random(0, 100)/100 <= lockedChance then
                b.locked = 1
            end
    ...
    -- in the event we didn't generate more than 5 bricks, try again
    if #bricks < 5 then
